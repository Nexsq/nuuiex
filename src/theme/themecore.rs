...
pub const BUILTIN_THEMES: &[(&str, &str)] = &[
    ...
    ("groove", include_str!("themes/groove.conf")),
];
...
pub struct Theme {
    ...
    pub fancy_bools_true: Gradient,
    pub fancy_bools_false: Gradient,
...
impl Theme {
    fn new_empty() -> Self {
        Self {
            ...
            fancy_bools_true: Gradient::default(),
            fancy_bools_false: Gradient::default(),
...
fn apply_theme_value(theme: &mut Theme, key: &str, val: &str) -> Result<(), String> {
    match key {
        ...
        "fancy_bools_true" => theme.fancy_bools_true = parse_gradient(val)?,
        "fancy_bools_false" => theme.fancy_bools_false = parse_gradient(val)?,
