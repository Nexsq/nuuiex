...
impl MonitorState {
    pub fn new() -> Self {
        ...
        let process_cpu = Arc::new(AtomicU32::new(0));
        ...
        let thread_handle = thread::spawn(move || {
            ...
            let gpu_rx = start_gpu_monitor(c_running.clone());
            ...
            while c_running.load(Ordering::Relaxed) {
                ...
                let (cpu_val, mem_u, mem_t, proc_cpu_val) = (0, 0, 0, 0.0_f32);
                ...
                c_process_cpu.store(proc_cpu_val.to_bits(), Ordering::Relaxed);
        ...
        if let Some(line) = stat.lines().next() {
            ...
            if parts.len() > 8 {
                ...
                if total_d > 0 {
                    ...
                    proc_cpu_usage = ((proc_d as f32 * 100.0) / total_d as f32).min(100.0);
                    *prev_proc = proc_time;
                }
        ...
        if GetSystemTimes(&mut idle, &mut kernel, &mut user) != 0 {
            ...
            if sys_diff > 0 {
                ...
                ) != 0
                {
                    ...
                    proc_cpu_usage = ((proc_diff as f32 * 100.0) / sys_diff as f32).min(100.0);
...
#[cfg(target_os = "windows")]
fn start_gpu_monitor(c_running: Arc<AtomicBool>) -> std::sync::mpsc::Receiver<u8> {
    ...
    std::thread::spawn(move || {
        ...
        if !c_running.load(Ordering::Relaxed) {
            return;
        }
